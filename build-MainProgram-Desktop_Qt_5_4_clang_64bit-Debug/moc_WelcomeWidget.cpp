...
#include "../MainProgram/WelcomeWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WelcomeWidget_t, stringdata) + ofs \
...
const QMetaObject WelcomeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WelcomeWidget.data,
      qt_meta_data_WelcomeWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WelcomeWidget.stringdata))
