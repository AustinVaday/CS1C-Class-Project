...
#include "../CS1C-Project-Master/maindisplay.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MainDisplay_t, stringdata) + ofs \
...
const QMetaObject MainDisplay::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MainDisplay.data,
      qt_meta_data_MainDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainDisplay.stringdata))
