...
#include "../CS1C-Project-Master/signupwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SignUpWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 61, 11)
    ...
    "SignUpWindow\0on_buttonBox_accepted\0\0"
    "Customer&\0customer\0bool&\0properField"
};
...
void SignUpWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_buttonBox_accepted((*reinterpret_cast< Customer(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    }
}
